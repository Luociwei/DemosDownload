...
- (void)displayImageView1
{
    NSBundle *bundle = [NSBundle bundleForClass:[self class]];
    UIImage *image = [UIImage imageNamed:@"Canvas 4" inBundle:bundle compatibleWithTraitCollection:nil];
//    UIImage *image = [UIImage imageNamed:@"Canvas 4"];
